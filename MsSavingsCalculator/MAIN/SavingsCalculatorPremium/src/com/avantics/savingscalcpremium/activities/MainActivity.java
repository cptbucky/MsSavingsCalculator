	...
	private void sendQuote() {
		...
		try {
			...
			xlExporter.writeCell(0, 4, resources.getString(R.string.cc_short),
					false, ws);
			xlExporter.writeCell(1, 4, binder.ccst.getValue().toString(),
					false, ws);
			xlExporter.writeCell(2, 4, binder.ccfr.getValue().toString(),
					false, ws);
			xlExporter.writeCell(3, 4, binder.cct.getValue().toString(),
					false, ws);
