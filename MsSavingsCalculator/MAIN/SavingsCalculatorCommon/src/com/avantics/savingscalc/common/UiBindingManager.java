...
public class UiBindingManager {
	...
	public UiBindingManager(View view) {
		...
		fincpci = new UiBindingContainer(
				(TextView) view.findViewById(R.id.FIncPci),
				formatters.CURRENCY_FORMATTER);
	...
	public Quote getSelectedQuote() {
		...
		quote.fpmsterminal = vendorterminal.getValue();
	...
	public void setSelectedQuote(Quote quote) {
		...
		vendorterminal.setValue(quote.fpmsterminal);
	}
